...
def convert_command_to_tensor_dataset(words,pred_config,args,pad_token_label_id):
...
def predict(command, pred_config):
    ...
    intent_label_lst = pred_config.intents
    slot_label_lst = pred_config.slots
    ...
    dataset = convert_command_to_tensor_dataset(words, pred_config, args, pad_token_label_id)
