...
def main(parameter):
    ...
    train_dataset = load_and_cache_examples(parameter, tokenizer, mode="train")
    dev_dataset = load_and_cache_examples(parameter, tokenizer, mode="dev")
    test_dataset = load_and_cache_examples(parameter, tokenizer, mode="test")
